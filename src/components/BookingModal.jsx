...
import { Calendar, Clock, MessageSquare, Phone, Mail, User, X, CheckCircle, AlertCircle, Info } from 'lucide-react';
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-semibold ml-2">{room.contact}</span>
                  </div>
                  <div>
                    <span className="text-gray-600">{t('roomType') || 'Room Type'}:</span>
              ...
              <div className="flex gap-3">
                ...
                >
                  {t('cancel') || 'Cancel'}
                   ...
                   disabled={isSubmitting || !formData.userName.trim() || !formData.userPhone.trim() || !formData.userEmail.trim()}
