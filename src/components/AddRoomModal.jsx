...
const AddRoomModal = ({ onClose, onAddRoom, initialRoom, isEdit }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.gender) {
      newErrors.gender = 'Please select gender availability';
    }
              ...
              <div className="grid grid-cols-2 gap-4">
                <label className={`flex items-center justify-center p-4 border-2 rounded-lg cursor-pointer transition-all ${
                  ...
                  <div className="text-center">
                    <div className="text-lg font-semibold">Boys</div>
                    <div className="text-sm text-gray-600">Male students only</div>
                  </div>
                </label>
                ...
                <label className={`flex items-center justify-center p-4 border-2 rounded-lg cursor-pointer transition-all ${
                  ...
                  />
                  <div className="text-center">
                    <div className="text-lg font-semibold">Girls</div>
                    <div className="text-sm text-gray-600">Female students only</div>
                  </div>
                </label>
              </div>
              {errors.gender && (
